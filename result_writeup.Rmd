...
grid.text("Class 2 data contains: share of households owing cellular phone ", x = unit(0.625, "npc"), y = unit(0.29, "npc"),gp=gpar(fontsize=15)， check.overlap = TRUE,just="left")
grid.text("and share of dwellings with metal versus thatch roof", x = unit(0.625, "npc"), y = unit(0.26, "npc"),gp=gpar(fontsize=15)， check.overlap = TRUE,just="left")
