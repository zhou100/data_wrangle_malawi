...
theme(plot.title = element_text(size = 12, face = "bold"),legend.title=element_text(size=20), legend.text=element_text(size=18),axis.text.x=element_text(size=15),axis.text.y=element_text(size=15),
 ...
 grid.text(paste("R Squared= ",r2list[1],sep = " "), x = unit(0.72, "npc"), y = unit(0.65, "npc"),gp=gpar(fontsize=14),just="left") 

 grid.text("Cutoff: 0 <= rCSI < 4 (food secure) ", x = unit(0.72, "npc"), y = unit(0.57, "npc"),gp=gpar(fontsize=14),just="left") 
 grid.text("4 <= rCSI < 17 (midly food insecure)", x = unit(0.72, "npc"), y = unit(0.54, "npc"),gp=gpar(fontsize=14),just="left") 
 grid.text("rCSI >=17 (moderately or severely", x = unit(0.72, "npc"), y = unit(0.51, "npc"),gp=gpar(fontsize=14),just="left") 
 grid.text("food insecure)", x = unit(0.72, "npc"), y = unit(0.48, "npc"),gp=gpar(fontsize=15),just="left") 


 grid.text("Area I: Overpredicting; mildly food ", x = unit(0.72, "npc"), y = unit(0.41, "npc"),gp=gpar(fontsize=14),just="left") 
  grid.text("insecure predicted as food secure", x = unit(0.72, "npc"), y = unit(0.38,"npc"),gp=gpar(fontsize=14),just="left") 
 grid.text("Area IIa: Overpredicting within food secure", x = unit(0.72, "npc"), y = unit(0.35, "npc"),gp=gpar(fontsize=14),just="left") 
  grid.text("Area IIb: Overpredicting within mildly", x = unit(0.72, "npc"), y = unit(0.32, "npc"),gp=gpar(fontsize=14),just="left") 
  grid.text("food insecure", x = unit(0.72, "npc"), y = unit(0.29, "npc"),gp=gpar(fontsize=14),just="left") 

grid.text("Area IIIa: Underpredicting within food secure", x = unit(0.72, "npc"), y = unit(0.26, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("Area IIIb: Underpredicting within mildly", x = unit(0.72, "npc"), y = unit(0.23, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("food insecure", x = unit(0.72, "npc"), y = unit(0.20, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("Area IV: Underpredicting; secure", x = unit(0.72, "npc"), y = unit(0.17, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("predicted as mildly insecure", x = unit(0.72, "npc"), y = unit(0.14, "npc"),gp=gpar(fontsize=15),just="left") 
...
grid.text(paste("R Squared= ",r2list[2],sep = " "), x = unit(0.72, "npc"), y = unit(0.65, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("Cutoff: 0 <= logFCS < 3.332 is poor", x = unit(0.72, "npc"), y = unit(0.57, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("food consumption score", x = unit(0.72, "npc"), y = unit(0.54, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("3.332 <= logFCS <= 3.738 is borderline", x = unit(0.72, "npc"), y = unit(0.51, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("food consumption score", x = unit(0.72, "npc"), y = unit(0.48, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("logFCS >= 3.738 is acceptable", x = unit(0.72, "npc"), y = unit(0.45, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("food consumption score", x = unit(0.72, "npc"), y = unit(0.42, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("Area I: Overpredicting; borderline  ", x = unit(0.72, "npc"), y = unit(0.35, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("predicted as acceptable", x = unit(0.72, "npc"), y = unit(0.32,"npc"),gp=gpar(fontsize=15),just="left") 
grid.text("Area IIa: Overpredicting within acceptable", x = unit(0.72, "npc"), y = unit(0.29, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("Area IIb: Overpredicting within borderline", x = unit(0.72, "npc"), y = unit(0.26, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("Area IIIa: Underpredicting within acceptable", x = unit(0.72, "npc"), y = unit(0.23, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("Area IIIb: Underpredicting within borderline", x = unit(0.72, "npc"), y = unit(0.20, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("Area IV: Underpredicting; acceptable", x = unit(0.72, "npc"), y = unit(0.17, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("predicted as borderline", x = unit(0.72, "npc"), y = unit(0.14, "npc"),gp=gpar(fontsize=15),just="left") 
...
ggplot(as.data.frame(HDDS_pair), aes(actual, predict)) +
  theme_classic() + geom_abline(intercept = 0, slope = 1)+
  theme(plot.margin = unit(c(1, 22, 1, 1), "lines"))  +
  theme(plot.title = element_text(size = 12, face = "bold"),legend.title=element_text(size=20), legend.text=element_text(size=18),axis.text.x=element_text(size=15),axis.text.y=element_text(size=15),
                 axis.title=element_text(size=17,face="bold") ) +
  scale_color_brewer(palette="Dark2")+
...
grid.text(paste("R Squared= ",r2list[3],sep = " "), x = unit(0.71, "npc"), y = unit(0.65, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("Cutoff: 0 <= HDDS < 3 is poor diversity", x = unit(0.71, "npc"), y = unit(0.58, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("3 <= HDDS <= 6 is medium diversity", x = unit(0.71, "npc"), y = unit(0.55, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("HDDS >= 6 is good diversity", x = unit(0.71, "npc"), y = unit(0.52, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("Area I: Overpredicting; medium diversity", x = unit(0.71, "npc"), y = unit(0.46, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("predicted as good diversity", x = unit(0.71, "npc"), y = unit(0.43,"npc"),gp=gpar(fontsize=15),just="left") 
grid.text("Area IIa: Overpredicting within medium ", x = unit(0.71, "npc"), y = unit(0.40, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("diversity", x = unit(0.71, "npc"), y = unit(0.37, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("Area IIb: Overpredicting within good diversity", x = unit(0.71, "npc"), y = unit(0.34, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("Area IIIa: Underpredicting within medium", x = unit(0.71, "npc"), y = unit(0.31, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("diversity", x = unit(0.71, "npc"), y = unit(0.28, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("Area IIIb: Underpredicting within good diversity", x = unit(0.71, "npc"), y = unit(0.25, "npc"),gp=gpar(fontsize=15),just="left") 

grid.text("Area IV: Underpredicting; good diversity", x = unit(0.71, "npc"), y = unit(0.22, "npc"),gp=gpar(fontsize=15),just="left") 
grid.text("predicted as medium diversity", x = unit(0.71, "npc"), y = unit(0.19, "npc"),gp=gpar(fontsize=15),just="left") 
...
#    theme(plot.margin = unit(c(1, 14, 1, 1), "lines"))  
# 
#  grid.text(paste("R Squared= ",r2list[1],sep = " "), x = unit(0.72, "npc"), y = unit(0.65, "npc"),gp=gpar(fontsize=15),just="left") 
#  grid.text("IPC only predictions in triangles", x = unit(0.72, "npc"), y = unit(0.62, "npc"),gp=gpar(fontsize=15)，just="left") 
#  grid.text("Cluster model predictions in dots", x = unit(0.72, "npc"), y = unit(0.59, "npc"),gp=gpar(fontsize=15)，just="left")
# 
#  grid.text("rCSI from 0 to 4 is food secure ", x = unit(0.72, "npc"), y = unit(0.44, "npc"),gp=gpar(fontsize=15),just="left") 
#  grid.text("rCSI from 4 to 17 is mildly insecure", x = unit(0.72, "npc"), y = unit(0.41, "npc"),gp=gpar(fontsize=15),just="left") 
#  grid.text("rCSI of 17 or above is moderately ", x = unit(0.72, "npc"), y = unit(0.38, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("or severely insecure ", x = unit(0.72, "npc"), y = unit(0.35, "npc"),gp=gpar(fontsize=15),just="left") 
# 
# 
#  grid.text("Area I:Overpredicting, actually mildly", x = unit(0.72, "npc"), y = unit(0.31, "npc"),gp=gpar(fontsize=15),just="left") 
#   grid.text("insecure and predicted as secure", x = unit(0.72, "npc"), y = unit(0.28,"npc"),gp=gpar(fontsize=15),just="left") 
#  grid.text("Area II:Overpredicting,", x = unit(0.72, "npc"), y = unit(0.25, "npc"),gp=gpar(fontsize=15),just="left") 
#   grid.text("but within the same category", x = unit(0.72, "npc"), y = unit(0.22, "npc"),gp=gpar(fontsize=15),just="left") 
# 
#  
# grid.text("Area III:Underpredicting,", x = unit(0.72, "npc"), y = unit(0.19, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("but within the same category", x = unit(0.72, "npc"), y = unit(0.16, "npc"),gp=gpar(fontsize=15),just="left") 
# 
# grid.text("Area IV:Underpredicting,actually secure", x = unit(0.72, "npc"), y = unit(0.13, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("and predicted as mildly insecure", x = unit(0.72, "npc"), y = unit(0.10, "npc"),gp=gpar(fontsize=15),just="left") 
# 
# 
# 
# 
...
#   grid.text("Cluster model predictions in dots", x = unit(0.72, "npc"), y = unit(0.59, "npc"),gp=gpar(fontsize=15)，just="left")
# 
# grid.text("logFCS of 3.738 or above is acceptable", x = unit(0.72, "npc"), y = unit(0.47, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("logFCS from 3.332 to 3.738 is borderline", x = unit(0.72, "npc"), y = unit(0.44, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("logFCS of value 3.332 or below is poor", x = unit(0.72, "npc"), y = unit(0.41, "npc"),gp=gpar(fontsize=15),just="left") 
# 
# grid.text("Area I:Overpredicting, actually borderline", x = unit(0.72, "npc"), y = unit(0.38, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("status and predicted as acceptable", x = unit(0.72, "npc"), y = unit(0.35,"npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("Area II:Overpredicting,", x = unit(0.72, "npc"), y = unit(0.32, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("but within the same category", x = unit(0.72, "npc"), y = unit(0.29, "npc"),gp=gpar(fontsize=15),just="left") 
# 
# grid.text("Area III:Underpredicting,", x = unit(0.72, "npc"), y = unit(0.26, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("but within the same category", x = unit(0.72, "npc"), y = unit(0.23, "npc"),gp=gpar(fontsize=15),just="left") 
# 
# grid.text("Area IV:Underpredicting,actually ", x = unit(0.72, "npc"), y = unit(0.2, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("acceptable and predicted as borderline", x = unit(0.72, "npc"), y = unit(0.17, "npc"),gp=gpar(fontsize=15),just="left") 
# 
#   
# 
# 
...
#   
#   theme(plot.margin = unit(c(1, 15, 1, 1), "lines")) 
# grid.text(paste("R Squared= ",r2list[3],sep = " "), x = unit(0.72, "npc"), y = unit(0.65, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("IPC only predictions in triangles", x = unit(0.72, "npc"), y = unit(0.62, "npc"),gp=gpar(fontsize=15)，just="left") 
# grid.text("Cluster model predictions in dots", x = unit(0.72, "npc"), y = unit(0.59, "npc"),gp=gpar(fontsize=15)，just="left")
# 
# 
# grid.text("HDDS of 6 or above is good diversity", x = unit(0.72, "npc"), y = unit(0.47, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("HDDS from 3 to 6 is medium diversity", x = unit(0.72, "npc"), y = unit(0.44, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("HDDS of value 3 or below is low diversity", x = unit(0.72, "npc"), y = unit(0.41, "npc"),gp=gpar(fontsize=15),just="left") 
# 
# grid.text("Area I:Overpredicting, actually medium", x = unit(0.72, "npc"), y = unit(0.38, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("diversity and predicted as good diversity", x = unit(0.72, "npc"), y = unit(0.35,"npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("Area II:Overpredicting,", x = unit(0.72, "npc"), y = unit(0.32, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("but within the same category", x = unit(0.72, "npc"), y = unit(0.29, "npc"),gp=gpar(fontsize=15),just="left") 
# 
# 
...
# grid.text("but within the same category", x = unit(0.72, "npc"), y = unit(0.23, "npc"),gp=gpar(fontsize=15),just="left") 
# 
# grid.text("Area IV:Underpredicting,actual medium", x = unit(0.72, "npc"), y = unit(0.2, "npc"),gp=gpar(fontsize=15),just="left") 
# grid.text("diversity and predicted as good diversity", x = unit(0.72, "npc"), y = unit(0.17, "npc"),gp=gpar(fontsize=15),just="left") 
# 
