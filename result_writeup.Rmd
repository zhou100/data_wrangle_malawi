...
theme(plot.title = element_text(size = 12, face = "bold"),legend.title=element_text(size=20), legend.text=element_text(size=18),axis.text.x=element_text(size=15),axis.text.y=element_text(size=15),
 ...
 grid.text(paste("R Squared= ",r2list[1],sep = " "), x = unit(0.74, "npc"), y = unit(0.8, "npc"),gp=gpar(fontsize=13),just="left") 

 grid.text("rCSI from 0 to 4 is food secure ", x = unit(0.74, "npc"), y = unit(0.47, "npc"),gp=gpar(fontsize=13),just="left") 
 grid.text("rCSI from 4 to 17 is mildly insecure", x = unit(0.74, "npc"), y = unit(0.44, "npc"),gp=gpar(fontsize=13),just="left") 

 grid.text("Area I:Overpredicting, actually mildly", x = unit(0.74, "npc"), y = unit(0.38, "npc"),gp=gpar(fontsize=13),just="left") 
  grid.text("insecure and predicted as secure", x = unit(0.74, "npc"), y = unit(0.35,"npc"),gp=gpar(fontsize=13),just="left") 
 grid.text("Area II:Overpredicting,", x = unit(0.74, "npc"), y = unit(0.32, "npc"),gp=gpar(fontsize=13),just="left") 
  grid.text("but within the same category", x = unit(0.74, "npc"), y = unit(0.29, "npc"),gp=gpar(fontsize=13),just="left") 

 
grid.text("Area III:Underpredicting,", x = unit(0.74, "npc"), y = unit(0.26, "npc"),gp=gpar(fontsize=13),just="left") 
grid.text("but within the same category", x = unit(0.74, "npc"), y = unit(0.23, "npc"),gp=gpar(fontsize=13),just="left") 

grid.text("Area IV:Underpredicting,actually secure", x = unit(0.74, "npc"), y = unit(0.2, "npc"),gp=gpar(fontsize=13),just="left") 
grid.text("and predicted as mildly insecure", x = unit(0.74, "npc"), y = unit(0.17, "npc"),gp=gpar(fontsize=13),just="left") 
...
theme(plot.title = element_text(size = 12, face = "bold"),legend.title=element_text(size=20), legend.text=element_text(size=18),axis.text.x=element_text(size=15),axis.text.y=element_text(size=15),
  ...
  geom_ribbon(data=subset(as.data.frame(logFCS_pair), 3.738 <= actual & actual <= 4.44), 
              aes(ymin=3.738,ymax=actual), fill="grey", alpha="0.2") +   # area 3 right 
  geom_ribbon(data=subset(as.data.frame(logFCS_pair), 3.332 <= actual & actual <= 3.738), 
              aes(ymin=actual,ymax=3.738), fill="grey", alpha="0.3") +   # area 2 left
  geom_ribbon(data=subset(as.data.frame(logFCS_pair), 3.738 <= actual & actual <= 4.44), 
              aes(ymin=actual,ymax=4.44), fill="grey", alpha="0.3") +            # area 2 right
  geom_ribbon(data=subset(as.data.frame(logFCS_pair), 3.332<= actual & actual <= 3.738), 
              aes(ymin=3.738,ymax=4.44), fill="grey", alpha="0.8") +        # area 1
  geom_ribbon(data=subset(as.data.frame(logFCS_pair), 3.738 <= actual & actual <= 4.44), 
              aes(ymin=3.332,ymax=3.738), fill="grey", alpha="0.6") +           # area 4
  
  annotate(geom = "text", size = 7, x = 3.5, y = 3.4, label = "III") +
  annotate(geom = "text", size = 7, x = 4, y = 3.8, label = "III") +
  annotate(geom = "text", size = 7, x = 3.5, y = 4, label = "I") +
  annotate(geom = "text", size = 7, x = 3.5, y = 3.7, label = "II") +
  annotate(geom = "text", size = 7, x = 4, y = 4, label = "II") +
  annotate(geom = "text", size = 7, x = 4, y = 3.5, label = "IV") +
  theme(plot.margin = unit(c(1, 15, 1, 1), "lines")) 

grid.text(paste("R Squared= ",r2list[2],sep = " "), x = unit(0.74, "npc"), y = unit(0.8, "npc"),gp=gpar(fontsize=13),just="left") 

grid.text("rCSI from 0 to 4 is food secure ", x = unit(0.74, "npc"), y = unit(0.47, "npc"),gp=gpar(fontsize=13),just="left") 
grid.text("rCSI from 4 to 4.44 is mildly insecure", x = unit(0.74, "npc"), y = unit(0.44, "npc"),gp=gpar(fontsize=13),just="left") 

grid.text("Area I:Overpredicting, actual mildly", x = unit(0.74, "npc"), y = unit(0.38, "npc"),gp=gpar(fontsize=13),just="left") 
grid.text("insecure and predicted as secure", x = unit(0.74, "npc"), y = unit(0.35,"npc"),gp=gpar(fontsize=13),just="left") 
grid.text("Area II:Overpredicting,", x = unit(0.74, "npc"), y = unit(0.32, "npc"),gp=gpar(fontsize=13),just="left") 
grid.text("but within the same category", x = unit(0.74, "npc"), y = unit(0.29, "npc"),gp=gpar(fontsize=13),just="left") 
...
grid.text("Area IV:Underpredicting,actual secure", x = unit(0.74, "npc"), y = unit(0.2, "npc"),gp=gpar(fontsize=13),just="left") 
grid.text("and predicted as mildly insecure", x = unit(0.74, "npc"), y = unit(0.444, "npc"),gp=gpar(fontsize=13),just="left") 
