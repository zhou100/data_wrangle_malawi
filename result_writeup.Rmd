...
p<-ggplot(as.data.frame(long_data[long_data$measure!="logFCS",]),aes(x=months,color=measure,y=Food_security,shape = measure,group=measure)) + theme_classic() + geom_path(size=2.5)+ geom_point(size=5)  
...
theme(plot.title = element_text(size = 12, face = "bold"),legend.title=element_text(size=20), legend.text=element_text(size=18),axis.text.x=element_text(size=15),axis.text.y=element_text(size=15),
                 axis.title=element_text(size=17,face="bold") )  +
  annotate(geom = "text", size = 7, x = 12.1, y = 1.5, label = paste("R Squared= ",r2list[1],sep = " ")) +
...
rplot <- rplot +  theme(plot.title = element_text(size = 12, face = "bold"),legend.title=element_text(size=20), legend.text=element_text(size=18),axis.text.x=element_text(size=15),axis.text.y=element_text(size=15),
 ...
 grid.text("market price, market access and soil quality", x = unit(0.625, "npc"), y = unit(0.32, "npc"),gp=gpar(fontsize=15)， check.overlap = TRUE,just="left") 
grid.text("Class 2 data contains roof type and cellphone ownership", x = unit(0.625, "npc"), y = unit(0.29, "npc"),gp=gpar(fontsize=15)， check.overlap = TRUE,just="left")
grid.text("Class 3 data contains household demographics and assets", x = unit(0.625, "npc"), y = unit(0.26, "npc"),gp=gpar(fontsize=15)， check.overlap = TRUE,just="left")
...
rplot <- rplot +  theme(plot.title = element_text(size = 12, face = "bold"),legend.title=element_text(size=20), legend.text=element_text(size=18),axis.text.x=element_text(size=15),axis.text.y=element_text(size=15),
 ...
 rplot = rplot + scale_color_grey(start = 0.8, end = 0.2) +  theme(plot.margin = unit(c(1, 18, 1, 1), "lines"))  
 rplot
 grid.text("Class 1 data contains past IPC values, precipitation", x = unit(0.625, "npc"), y = unit(0.35, "npc"),gp=gpar(fontsize=15)， check.overlap = TRUE,just="left") 
 grid.text("market price, market access and soil quality", x = unit(0.625, "npc"), y = unit(0.32, "npc"),gp=gpar(fontsize=15)， check.overlap = TRUE,just="left") 
grid.text("Class 2 data contains roof type and cellphone ownership", x = unit(0.625, "npc"), y = unit(0.29, "npc"),gp=gpar(fontsize=15)， check.overlap = TRUE,just="left")
