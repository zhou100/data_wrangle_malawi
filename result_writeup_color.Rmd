...
geom_vline(xintercept=log(28),linetype=2) + geom_vline(xintercept=log(42),linetype=2)+
 ...
 theme_classic()+
  theme(plot.title = element_text(size = 30, face = "bold"),legend.title=element_text(size=30), legend.text=element_text(size=30),axis.text.x=element_text(size=30),axis.text.y=element_text(size=30),
                 axis.title=element_text(size=30,face="bold") ) 

 p
 ggsave("output/figures/Density_new/fcs_ipc.png", width = 15, height = 15)

 
 
p= ggplot(as.data.frame(plot_long_HDDS),aes(x=HDDS, color=level))+ geom_density(alpha=0.30,show.legend = TRUE) +
...
p
ggsave("output/figures/Density_new/hdds_ipc.png", width = 15, height = 15)
 


p = ggplot(as.data.frame(plot_long_RCSI),aes(x=RCSI, color=level))+ stat_density(data=plot_long_ipc_RCSI,aes(x=RCSI,y=..scaled../2.3,color=level)) + geom_density(alpha=0.30)+xlim(0, 45) + theme_classic()+
...
ggsave("output/figures/Density_new/rcsi_ipc.png", width = 15, height = 15)
...
ord_s <- c("% Type II","% Type I","Accuracy")
...
rplot<-ggplot(data = FCS_full, aes(x =Level, y = Value,colour = Model.Measure,shape=Model)) 
rplot<-rplot + geom_point(size=7)
...
rplot<-ggplot(data = HDDS, aes(x =Level, y = Value,colour = Model.Measure,shape=Model)) 
rplot<-rplot + geom_point(size=7)
rplot<-rplot + labs( x = "Geo-spatial Level", y = "Accuracy/Type I/Type II")
...
rplot<-ggplot(data = rCSI, aes(x =Level, y = Value,colour = Model.Measure,shape=Model)) 
rplot<-rplot + geom_point(size=7)
rplot<-rplot + labs( x = "Geo-spatial Level", y = "Accuracy/Type I/Type II")
...
rplot<-ggplot(data = FCS_tail, aes(x =Level, y = Value,colour = Model.Measure,shape=Model)) 
rplot<-rplot + geom_point(size=7)
rplot<-rplot + labs( x = "Geo-spatial Level", y = "Accuracy/Type I/Type II")
