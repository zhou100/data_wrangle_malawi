...
# 
# grid.text("Area IIIb: Underpredicting within good diversity", x = unit(0.85, "npc"), y = unit(0.25, "npc"),gp=gpar(fontsize=15),just="left") 
# 
...
#  grid.text("Area II:Overpredicting,", x = unit(0.85, "npc"), y = unit(0.25, "npc"),gp=gpar(fontsize=15),just="left") 
...
p = ggplot(as.data.frame(plot_long_RCSI),aes(x=RCSI, color=level))+ stat_density(data=plot_long_ipc_RCSI,aes(x=RCSI,y=..scaled../2.3,color=level)) + geom_density(alpha=0.25)+xlim(0, 45) + 
  geom_vline(xintercept=4,linetype=2) + geom_vline(xintercept=17,linetype=2)+ geom_vline(xintercept=42,linetype=2)+
   scale_y_continuous(name= "density",sec.axis = sec_axis(~.*3.125, name = "density (IPC value only) ")) +
    theme(plot.title = element_text(size = 12, face = "bold"),legend.title=element_text(size=25), legend.text=element_text(size=25),axis.text.x=element_text(size=15),axis.text.y=element_text(size=15),
                 axis.title=element_text(size=17,face="bold") ) +
  theme_classic()
p
